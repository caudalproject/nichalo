...
const FAQS = [
  ...
  },
  {
    ...
    a: "1 análisis gratis, por única vez (no se recarga todos los meses), con 30 publicaciones analizadas y el informe completo, sin restricciones y sin tarjeta. Cuando lo uses, podés seguir validando con un pack de créditos o suscribiéndote a Pro.",
  },
];
